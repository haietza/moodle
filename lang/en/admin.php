...
$string['user'] = 'User';
$string['userbackupquota'] = 'User backup files space';
$string['userbackupquota_desc'] = 'The maximum amount of data that each user can store in their backup files area. Enter 0 for the default of none.';
